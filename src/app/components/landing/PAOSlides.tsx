    ...
    const paoTypes = [
      {
        ...
        description: "Centralized power structure with a single ruler making decisions on-chain.",
        icon: "👑"
      },
      {
        title: "Sortition",
        description: "Random selection of governance participants for decision-making roles.",
        icon: "🎲"
      },
      {
        title: "Military Junta",
        description: "Governance by a committee of military leaders with stratified voting power.",
        icon: "🪖"
      },
      {
        title: "Sociocracy",
        description: "Nested circles of decision-making with consent-based governance.",
        icon: "🔄"
      },
      {
        title: "Conviction Voting",
        description: "Voting power increases over time to reward long-term stakeholders.",
        icon: "⏳"
      },
      {
        title: "Direct Democracy",
        description: "All participants have equal voting rights on all decisions.",
        icon: "🗳️"
      }
    ];
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-teal-900 via-black to-teal-800 py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <span className="block mt-2 text-xl md:text-2xl text-teal-100">Your data is safe and secured</span>
          </motion.h2>
              ...
              {[...paoTypes, ...paoTypes].map((pao, index) => (
                ...
                >
                  ...
                  <div className="relative p-6 z-10">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">{pao.title}</h3>
