  ...
  return (
    <header className={`fixed top-0 left-0 bg-black right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-black shadow-lg' : 'bg-transparent'}`}>
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <Link href="/create-pao" className="hidden md:block bg-[#008080] font-semibold text-white px-8 py-2 rounded-lg border-2 border-[#008080] hover:bg-black hover:text-[#008080] transition-colors duration-300">
          Create PAO
        </Link>
      </div>
